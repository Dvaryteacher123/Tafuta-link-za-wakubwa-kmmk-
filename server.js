...
// 1. Tuma ombi la malipo kwenda HarakaPay na uhifadhi pending kwenye Firestore moja kwa moja
app.post('/api/v1/collect', async (req, res) => {
    ...
    try {
        ...
        // Tunatumia order_id ya HarakaPay au tunatengeneza yetu kama haijapatikana ili isikatae
        const orderId = data.order_id || ('HP_' + Date.now());

        // Tunatunza kwenye Firestore oda ikiwa pending bila masharti magumu
